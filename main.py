...
class video(Scene):
    def construct(self):
        ...
        ax=Axes(x_range=[-10,10,1],
                ...
                x_length=15,
                y_length=8,
                axis_config={"include_tip" : False,"include_numbers" : False}).set_color("white")
        ...
        #self.play()
        self.play(t0.animate.set_value(3),t1.animate.set_value(-3),t2.animate.set_value(-3),t3.animate.set_value(2), run_time=8) #cambia el valor de los parametros
